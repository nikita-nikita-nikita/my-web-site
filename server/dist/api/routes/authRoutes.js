...
router
    ...
    .post("/register", registerMiddleware_1.default, (req, res, next) => authService.registerUser(req.user)
    .then(data => res.send(data))
    .catch(next))
    .post("/login", logger, loginMiddleware_1.default, (req, res, next) => authService.login(req.user)
    .then(data => res.send(data))
    .catch(next))
    .put("/change", changeUserMiddleware_1.default, (req, res, next) => 
// @ts-ignore
