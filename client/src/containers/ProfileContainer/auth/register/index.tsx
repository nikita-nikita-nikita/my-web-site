...
const RegisterForm:React.FunctionComponent<Props> = ({register}) => {
        ...
        <Form name="registrationForm" size="large" onSubmit={submit}>
            <Segment>
                ...
                <Form.Input
                    ...
                    onBlur={() => setPasswordValid(password.length>=6&&password===confirmedPassword)}
                />
                <Form.Input
                    fluid
                    icon="lock"
                    ...
                    error={!isPasswordValid}
                    onBlur={() => setPasswordValid(Boolean(password)&&password===confirmedPassword)}
                />
